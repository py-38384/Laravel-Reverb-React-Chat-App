                                ...
                                if (conversation.type === 'private') {
                                        ...
                                        <tr key={conversation.id}>
                                            ...
                                            <td className="relative border border-gray-300 px-4 py-2 dark:border-gray-700 ">
                                                <div className='w-[40px] h-[40px] flex items-center justify-center'>                                                  
                                                    <Link href={route('chat', conversation.id)} className='hover:bg-gray-100 w-full h-full dark:hover:bg-gray-800 flex items-center justify-center rounded'>
                                                        <MessagesSquare/>
                                                    </Link>
                                                </div>
                                    ...
                                    return (
                                        <tr key={conversation.id}>
                                            ...
                                            <td className="border border-gray-300 px-4 py-2 dark:border-gray-700">Test</td>
                                            <td className="relative border border-gray-300 px-4 py-2 dark:border-gray-700">
                                                <div className='w-[40px] h-[40px] bg-red-700'>                                                  
                                                    <Link href={route('chat', conversation.id)} className='hover:bg-gray-100 dark:hover:bg-gray-800'>
                                                        <MessagesSquare/>
                                                    </Link>
                                                </div>
                                                <span className={`absolute top-0 left-[45px] ${unSeenMessageCount ? 'block' : 'hidden'} font-bold text-red-500`}>
